        ...
        <div className={styles.FAQSBox}>
          ...
          <div className={styles.FAQSBox1}>
            <div className={styles.FAQdiv} onClick={() => handleArrow('section1')}>
              <h4>Why should I choose PieGP for my RuneScape needs?</h4>
              <IoIosArrowForward 
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section1' ? styles.show : styles.hide}`}>
              ...
              <br />
              <p>PieGP offers a variety of payment methods, providing our customers with the option that works best for them. PieGP doesn’t require ID verification, plain and simple. We value your privacy and security, and our team doesn’t request you to prove who you are to complete a transaction. Speaking of our team, if you need any assistance with the purchase, every PieGP agent has been trained from years of experience to provide the best possible experience. We aim to deliver all orders within minutes and are readily available to answer questions or help at any time via our live chat.</p>
            </div>
          </div>
          ...
          <div className={styles.FAQSBox4}>
            <div className={styles.FAQdiv} onClick={() => handleArrow('section4')}>
              <h4>Is buying from PieGP safe?</h4>
              <IoIosArrowForward 
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section4' ? styles.show : styles.hide}`}>
              <p>As with everything, it depends on who you purchase from and what the seller does to protect you. Here at PieGP, we believe in protecting our customers to the best of our ability. Our customer satisfaction is our top priority. With this in mind, and from the lessons from our time in the market, we’ve taken steps to protect you.
              </p>
              <br />
              <br />
              <p>
          ...
          <div className={styles.FAQSBox5}>
            <div className={styles.FAQdiv} onClick={() => handleArrow('section5')}>
              <h4>Can I sell my OSRS and RS3 gold to PieGP?</h4>
              <IoIosArrowForward 
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section5' ? styles.show : styles.hide}`}>
              <p>Absolutely! PieGP prides itself on being able to provide a variety of payment methods and the best prices in the market. Whether you’re selling gold from a big item drop, or taking a break from RuneScape, we are always purchasing gold, and you can feel safe in knowing you’re picking a trustworthy site to sell to. 
          ...
          <div className={styles.FAQSBox6}>
            ...
            <div className={`${styles.FAQpTag} ${openSection === 'section6' ? styles.show : styles.hide}`}>
              <p>No, a registered account isn’t required to use PieGP. Whether you’re selling, swapping, or buying gold, you can do so freely without an account. PieGP believes in privacy. and we understand that not everybody wants to use an account. 
				
              </p>
              <br />
              <br />
              <p>With that being said, though, by registering, you gain access to unique features such as easy access to your order history, exclusive discounts, and updated notices on what’s new at PieGP. Registration will always be free, so you’re welcome to at any point.</p>
            </div>
          </div>
